# openapi_client.ChangeRequestsApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ChangeRequestsApi(api_client)
    change_request_create_input = openapi_client.ChangeRequestCreateInput() # ChangeRequestCreateInput | 
