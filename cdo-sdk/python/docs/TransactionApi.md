# cdo_sdk_python.TransactionApi

All URIs are relative to *https://edge.us.cdo.cisco.com/api/rest*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_transaction**](TransactionApi.md#get_transaction) | **GET** /v1/transactions/{transactionUid} | Get Transaction
...
with cdo_sdk_python.ApiClient(configuration) as api_client:
    ...
    api_instance = cdo_sdk_python.TransactionApi(api_client)
