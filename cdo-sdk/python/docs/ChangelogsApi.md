...
with cdo_sdk_python.ApiClient(configuration) as api_client:
    ...
    changelog_uid = 'changelog_uid_example' # str | The unique identifier, represented as a UUID, of the changelog in SCC.
...
------------- | ------------- | ------------- | -------------
 **changelog_uid** | **str**| The unique identifier, represented as a UUID, of the changelog in SCC. | 
