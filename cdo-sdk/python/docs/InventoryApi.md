...
Onboard a Duo Admin Panel to the CDO tenant. The credentials to onboard the Duo Admin Panel to SCC must be generated by creating an Admin API application on https://www.duo.com. This operation returns a link to a transaction object that can be used to monitor the progress of the operation.
...
|-------------|-------------|------------------|
**202** | SCC Transaction object that can be used to track the progress of the onboarding operation |  -  |
...
This is an asynchronous operation to delete cdFMC managed FTD device in the CDO tenant. This operation returns a link to a transaction object that can be used to monitor the progress of the operation. The reason this operation is asynchronous is because the device is first removed from the cdFMC, following which it is deleted from the SCC tenant.
...
with cdo_sdk_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = cdo_sdk_python.InventoryApi(api_client)
    device_uid = 'device_uid_example' # str | The unique identifier, represented as a UUID, of the cdFMC managed FTD device in SCC.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **device_uid** | **str**| The unique identifier, represented as a UUID, of the cdFMC managed FTD device in SCC. | 
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**202** | SCC Transaction object that can be used to track the progress of the deletion operation. |  -  |
**400** | Invalid input provided. Check the response for details. |  -  |
**401** | Request not authorized. |  -  |
**403** | User does not have sufficient privileges to perform this operation. |  -  |
**500** | Internal server error. |  -  |
...
Delete a Cloud Service by UID in the SCC tenant.
...
with cdo_sdk_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = cdo_sdk_python.InventoryApi(api_client)
    cloud_service_uid = 'cloud_service_uid_example' # str | The unique identifier, represented as a UUID, of the cloud service in SCC.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **cloud_service_uid** | **str**| The unique identifier, represented as a UUID, of the cloud service in SCC. | 
...
Delete a device by UID in the SCC tenant. On-prem FMCs and cloud-delivered FMCs cannot be deleted using this endpoint.
...
with cdo_sdk_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = cdo_sdk_python.InventoryApi(api_client)
    device_uid = 'device_uid_example' # str | The unique identifier, represented as a UUID, of the device in SCC.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **device_uid** | **str**| The unique identifier, represented as a UUID, of the device in SCC. | 
...
Delete a Device Manager by UID in the SCC tenant.
...
with cdo_sdk_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = cdo_sdk_python.InventoryApi(api_client)
    device_manager_uid = 'device_manager_uid_example' # str | The unique identifier, represented as a UUID, of the device manager in SCC.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **device_manager_uid** | **str**| The unique identifier, represented as a UUID, of the device manager in SCC. | 
...
Delete a template device by UID in the SCC tenant.
...
with cdo_sdk_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = cdo_sdk_python.InventoryApi(api_client)
    template_device_uid = 'template_device_uid_example' # str | The unique identifier, represented as a UUID, of the template device in SCC.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **template_device_uid** | **str**| The unique identifier, represented as a UUID, of the template device in SCC. | 
...
This is an asynchronous operation to deploy changes made to an ASA device's configuration on SCC to the device. This operation returns a link to a transaction object that can be used to monitor the progress of the operation.
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**202** | SCC Transaction object that can be used to track the progress of the ASA deploy operation. |  -  |
**400** | Invalid input provided. Check the response for details. |  -  |
**401** | Request not authorized. |  -  |
**403** | User does not have sufficient privileges to perform this operation. |  -  |
...
This is an asynchronous operation to Enable Multicloud Defense for the SCC tenant. This operation returns a link to a transaction object that can be used to monitor the progress of the operation.
...
This is an asynchronous operation to execute CLI commands in the SCC tenant.
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**202** | SCC Transaction object that can be used to track the progress of the execute CLI operation |  -  |
**400** | Invalid input provided. Check the response for details. |  -  |
**401** | Request not authorized. |  -  |
**403** | User does not have sufficient privileges to perform this operation. |  -  |
**500** | Internal server error. |  -  |
...
This is an asynchronous operation to execute CLI macro command in the SCC tenant.
...
Complete registration of an FTD device managed by an FMC to the SCC tenant. Call this API endpoint after you have created an FTD and pasted the generated CLI output in the FTD. This operation returns a link to a transaction object that can be used to monitor the progress of the operation.
...
Get a Cloud Service by UID in the SCC tenant.
...
Get a list of Cloud Services in the SCC tenant.
...
Get a device by UID in the SCC tenant
...
Get a Device Manager by UID in the SCC tenant.
...
Fetch a list of Device Managers (on-prem FMCs and cloud-delivered FMCs) in the SCC tenant.
...
Get a list of devices in the SCC tenant.
...
with cdo_sdk_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = cdo_sdk_python.InventoryApi(api_client)
    fmc_uid = 'fmc_uid_example' # str | The unique identifier, represented as a UUID, of the FMC in SCC.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **fmc_uid** | **str**| The unique identifier, represented as a UUID, of the FMC in SCC. | 
...
Get a template device by UID in the SCC tenant.
...
Get a list of template devices in the SCC tenant.
...
Modify a Cloud Service by UID in the SCC tenant.
...
Modify a device in the SCC tenant
...
Modify a device manager by UID in the SCC tenant.
...
Modify a template device in the SCC tenant.
...
This is an asynchronous operation to onboard an ASA to a SCC tenant. This operation returns a link to a transaction object that can be used to monitor the progress of the operation.
...
Onboard a IOS device in the SCC tenant. This operation returns a link to a transaction object that can be used to monitor the progress of the operation.
...
This is an asynchronous operation to read the latest configuration on an ASA device in to the SCC tenant. This operation returns a link to a transaction object that can be used to monitor the progress of the operation.
...
with cdo_sdk_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = cdo_sdk_python.InventoryApi(api_client)
    device_uid = 'device_uid_example' # str | The unique identifier, represented as a UUID, of the ASA device in SCC.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **device_uid** | **str**| The unique identifier, represented as a UUID, of the ASA device in SCC. | 
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**202** | SCC Transaction object that can be used to track the progress of the read operation |  -  |
**400** | Invalid input provided. Check the response for details. |  -  |
**401** | Request not authorized. |  -  |
**403** | User does not have sufficient privileges to perform this operation. |  -  |
**500** | Internal server error. |  -  |
...
This is an asynchronous operation to re-establish the connection between an ASA and the SCC cloud. This operation returns a link to a transaction object that can be used to monitor the progress of the operation.
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**202** | SCC Transaction object that can be used to track the progress of the reconnecting operation. |  -  |
**400** | Invalid input provided. Check the response for details. |  -  |
**401** | Request not authorized. |  -  |
**403** | User does not have sufficient privileges to perform this operation. |  -  |
**500** | Internal server error. |  -  |
