...
**items** | [**List[DeviceLicenseDto]**](DeviceLicenseDto.md) | The list of items retrieved. | [optional] 
...
device_license_page_instance = DeviceLicensePage.from_json(json)
# print the JSON string representation of the object
print(DeviceLicensePage.to_json())

# convert the object into a dict
device_license_page_dict = device_license_page_instance.to_dict()
# create an instance of DeviceLicensePage from a dict
device_license_page_form_dict = device_license_page.from_dict(device_license_page_dict)
```
