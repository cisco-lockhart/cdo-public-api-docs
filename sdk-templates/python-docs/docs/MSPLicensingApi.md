...
[**get_msp_msla_device_entitlement_by_uid**](MSPLicensingApi.md#get_msp_msla_device_entitlement_by_uid) | **GET** /v1/msp/licenses/msla/devices/{uid} | Get MSP MSLA device entitlement by UID
[**get_msp_msla_device_entitlements**](MSPLicensingApi.md#get_msp_msla_device_entitlements) | **GET** /v1/msp/licenses/msla/devices | Get MSP MSLA device entitlements
[**get_msp_msla_license_usage**](MSPLicensingApi.md#get_msp_msla_license_usage) | **GET** /v1/msp/licenses/msla/usage | Get MSP MSLA license usage
...
Get device licenses, across all tenants, managed by the MSP portal. Note: This endpoint is currently in limited availability. Please contact your Cisco account team or Cisco TAC to request access.
...
Get device licenses for device managed by the MSP portal using its UID. Note: This endpoint is currently in limited availability. Please contact your Cisco account team or Cisco TAC to request access.
...
**401** | Request not authorized. |  -  |
**404** | MSP-managed device not found |  -  |
**405** | Method not allowed. |  -  |
**500** | Internal server error. |  -  |

[[Back to top]](#) [[Back to API list]](../README.md#documentation-for-api-endpoints) [[Back to Model list]](../README.md#documentation-for-models) [[Back to README]](../README.md)

# **get_msp_msla_device_entitlement_by_uid**
> MspMslaDeviceEntitlementDto get_msp_msla_device_entitlement_by_uid(uid)

Get MSP MSLA device entitlement by UID

Get a single MSP MSLA device entitlement assignment by its UID.
...
with scc_firewall_manager_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = scc_firewall_manager_sdk.MSPLicensingApi(api_client)
    uid = 'uid_example' # str | The unique identifier (UID) of the MSLA entitlement assignment

    try:
        # Get MSP MSLA device entitlement by UID
        api_response = api_instance.get_msp_msla_device_entitlement_by_uid(uid)
        print("The response of MSPLicensingApi->get_msp_msla_device_entitlement_by_uid:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MSPLicensingApi->get_msp_msla_device_entitlement_by_uid: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **uid** | **str**| The unique identifier (UID) of the MSLA entitlement assignment | 

### Return type

[**MspMslaDeviceEntitlementDto**](MspMslaDeviceEntitlementDto.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | MSP MSLA device entitlement assignment for the specified UID |  -  |
**401** | Request not authorized. |  -  |
**403** | User does not have sufficient privileges to perform this operation. |  -  |
**404** | MSP MSLA device entitlement not found for the specified UID |  -  |
**405** | Method not allowed. |  -  |
**500** | Internal server error. |  -  |

[[Back to top]](#) [[Back to API list]](../README.md#documentation-for-api-endpoints) [[Back to Model list]](../README.md#documentation-for-models) [[Back to README]](../README.md)

# **get_msp_msla_device_entitlements**
> MspMslaDevicePage get_msp_msla_device_entitlements(limit=limit, offset=offset, q=q)

Get MSP MSLA device entitlements

Get a paginated list of MSLA device entitlement assignments across all managed tenants in the MSP portal.
...
with scc_firewall_manager_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Get MSP MSLA device entitlements
        api_response = api_instance.get_msp_msla_device_entitlements(limit=limit, offset=offset, q=q)
        print("The response of MSPLicensingApi->get_msp_msla_device_entitlements:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MSPLicensingApi->get_msp_msla_device_entitlements: %s\n" % e)
```
...
[**MspMslaDevicePage**](MspMslaDevicePage.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | List of MSP MSLA device entitlement assignments |  -  |
**401** | Request not authorized. |  -  |
**403** | User does not have sufficient privileges to perform this operation. |  -  |
**405** | Method not allowed. |  -  |
**500** | Internal server error. |  -  |
...
# **get_msp_msla_license_usage**
> MspMslaUsagePage get_msp_msla_license_usage(limit=limit, offset=offset, q=q)

Get MSP MSLA license usage

Get a paginated list of MSLA entitlement consumption across all managed tenants in the MSP portal.
...
```python
import scc_firewall_manager_sdk
from scc_firewall_manager_sdk.models.msp_msla_usage_page import MspMslaUsagePage
from scc_firewall_manager_sdk.rest import ApiException
from pprint import pprint
...
with scc_firewall_manager_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Get MSP MSLA license usage
        api_response = api_instance.get_msp_msla_license_usage(limit=limit, offset=offset, q=q)
        print("The response of MSPLicensingApi->get_msp_msla_license_usage:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MSPLicensingApi->get_msp_msla_license_usage: %s\n" % e)
```
...
[**MspMslaUsagePage**](MspMslaUsagePage.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | MSP MSLA entitlement consumption across managed tenants |  -  |
**401** | Request not authorized. |  -  |
**403** | User does not have sufficient privileges to perform this operation. |  -  |
**405** | Method not allowed. |  -  |
**500** | Internal server error. |  -  |
...
Get Smart Account identified by UID. Note: This endpoint is currently in limited availability. Please contact your Cisco account team or Cisco TAC to request access.
...
Get the Smart Accounts and the number of Virtual Accounts used by MSP-managed tenants. Note: This endpoint does not display all the Smart Accounts, or number of Virtual Accounts within a Smart Account, to which the customer has access. Only Smart Accounts — and number of Virtual Accounts therein — that have licenses used by devices in MSP-managed tenants are displayed. Note: This endpoint is currently in limited availability. Please contact your Cisco account team or Cisco TAC to request access.
...
Get Virtual Account identified by UID within a specific Smart Account. Note: This endpoint is currently in limited availability. Please contact your Cisco account team or Cisco TAC to request access.
...
This endpoint returns information on all of the licenses used by devices across all MSP-managed tenants that are registered to Smart License using a token generated in this Virtual Account. Note: This endpoint is currently in limited availability. Please contact your Cisco account team or Cisco TAC to request access.
...
Get the Virtual Accounts for a specific Smart Account used by MSP-managed tenants. Note: This endpoint does not display all the Virtual Accounts within the Smart Account to which the customer has access. Only Virtual Accounts that have licenses used by devices in MSP-managed tenants are displayed. Note: This endpoint is currently in limited availability. Please contact your Cisco account team or Cisco TAC to request access.
