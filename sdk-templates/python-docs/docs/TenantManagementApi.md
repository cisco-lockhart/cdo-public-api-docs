...
------------- | ------------- | -------------
[**get_current_tenant**](TenantManagementApi.md#get_current_tenant) | **GET** /v1/tenants/me | Get Current Tenant
...
with scc_firewall_manager_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Current Tenant
        api_response = api_instance.get_current_tenant()
        print("The response of TenantManagementApi->get_current_tenant:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TenantManagementApi->get_current_tenant: %s\n" % e)
```
