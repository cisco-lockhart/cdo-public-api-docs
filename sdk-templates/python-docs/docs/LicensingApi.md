...
This endpoint exports all of the licenses used by devices across this tenant that are registered to Smart License using a token generated in this Virtual Account. Note: This endpoint is currently in limited availability. Please contact your Cisco account team or Cisco TAC to request access.
...
Get a paginated list of device licenses. Note: This endpoint is currently in limited availability. Please contact your Cisco account team or Cisco TAC to request access.
...
Retrieves the device licensing information for a specific device identified by UID. Note: This endpoint is currently in limited availability. Please contact your Cisco account team or Cisco TAC to request access.
...
# **get_msla_devices**
> MslaDevicePage get_msla_devices(limit=limit, offset=offset, q=q)

Get MSLA Device Entitlements

Get a paginated list of MSLA entitlement assignments for devices in the tenant. Each item represents one entitlement assigned to one device.
...
with scc_firewall_manager_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Get MSLA Device Entitlements
        api_response = api_instance.get_msla_devices(limit=limit, offset=offset, q=q)
        print("The response of LicensingApi->get_msla_devices:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LicensingApi->get_msla_devices: %s\n" % e)
```
...
[**MslaDevicePage**](MslaDevicePage.md)
...
# **get_msla_usage**
> MslaUsagePage get_msla_usage(limit=limit, offset=offset)

Get MSLA License Usage

Get the MSLA entitlements assigned to this tenant and the number of devices consuming each entitlement. All assigned entitlements are returned, including those with no consuming devices. The consumption counts are derived from the most recent cdFMC poll, whose timestamp is returned in lastPolledAt.
...
with scc_firewall_manager_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Get MSLA License Usage
        api_response = api_instance.get_msla_usage(limit=limit, offset=offset)
        print("The response of LicensingApi->get_msla_usage:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LicensingApi->get_msla_usage: %s\n" % e)
```
...
[**MslaUsagePage**](MslaUsagePage.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | MSLA license usage for the tenant |  -  |
**401** | Request not authorized. |  -  |
**403** | MSLA licensing is not enabled for this tenant |  -  |
**405** | Method not allowed. |  -  |
**500** | Internal server error. |  -  |
...
Get the Smart Accounts and the number of Virtual Accounts used in this tenant. Note: This endpoint does not display all the Smart Accounts, or number of Virtual Accounts within a Smart Account, to which the customer has access. Only Smart Accounts — and number of Virtual Accounts therein — that have licenses used by devices in this tenant are displayed. Note: This endpoint is currently in limited availability. Please contact your Cisco account team or Cisco TAC to request access.
...
This endpoint returns information on all of the licenses used by devices across this tenant that are registered to Smart License using a token generated in this Virtual Account. Note: This endpoint is currently in limited availability. Please contact your Cisco account team or Cisco TAC to request access.
...
Get the Virtual Accounts for a specific Smart Account used in this tenant. Note: This endpoint does not display all the Virtual Accounts within the Smart Account to which the customer has access. Only Virtual Accounts that have licenses used by devices in this tenant are displayed. Note: This endpoint is currently in limited availability. Please contact your Cisco account team or Cisco TAC to request access.
