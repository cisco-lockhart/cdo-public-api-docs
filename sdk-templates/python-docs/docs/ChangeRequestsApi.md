# scc_firewall_manager_sdk.ChangeRequestsApi
...
with scc_firewall_manager_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = scc_firewall_manager_sdk.ChangeRequestsApi(api_client)
    change_request_create_input = scc_firewall_manager_sdk.ChangeRequestCreateInput() # ChangeRequestCreateInput | 
