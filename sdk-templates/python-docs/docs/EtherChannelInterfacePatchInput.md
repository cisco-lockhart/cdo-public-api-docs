...
**enabled** | **bool** | Indicates whether the interface is enabled. | [optional] [default to False]
**ipv4** | [**InterfaceIpv4Address**](InterfaceIpv4Address.md) |  | [optional] 
**ipv6** | [**InterfaceIpv6Address**](InterfaceIpv6Address.md) |  | [optional] 
**lacp_mode** | **str** | Link Aggregation Control Protocol (LACP) mode of the EtherChannel interface. | [optional] 
...
**management_only** | **bool** | Indicates if the interface is used exclusively for management traffic and not regular user or data traffic. | [optional] [default to False]
...
**monitor_interface** | **bool** | Indicates if the interface is actively monitored as part of an HA setup. The check determines if the interface is functioning correctly and whether a failover to a standby device should be triggered, if required. | [optional] [default to False]
...
ether_channel_interface_patch_input_instance = EtherChannelInterfacePatchInput.from_json(json)
# print the JSON string representation of the object
print(EtherChannelInterfacePatchInput.to_json())

# convert the object into a dict
ether_channel_interface_patch_input_dict = ether_channel_interface_patch_input_instance.to_dict()
# create an instance of EtherChannelInterfacePatchInput from a dict
ether_channel_interface_patch_input_form_dict = ether_channel_interface_patch_input.from_dict(ether_channel_interface_patch_input_dict)
```
