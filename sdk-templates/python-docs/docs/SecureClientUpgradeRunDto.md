...
**upgrade_run_status** | **str** | The current status of the upgrade run. One of: UPLOADING_IMAGES, CHECKING_IMAGES_UPLOAD_RESULTS, UPDATING_RA_VPN_CONFIG, DELETING_OLD_IMAGES, DONE, ERROR. | [optional] 
