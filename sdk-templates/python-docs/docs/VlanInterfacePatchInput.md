...
vlan_interface_patch_input_instance = VlanInterfacePatchInput.from_json(json)
# print the JSON string representation of the object
print(VlanInterfacePatchInput.to_json())

# convert the object into a dict
vlan_interface_patch_input_dict = vlan_interface_patch_input_instance.to_dict()
# create an instance of VlanInterfacePatchInput from a dict
vlan_interface_patch_input_form_dict = vlan_interface_patch_input.from_dict(vlan_interface_patch_input_dict)
```
