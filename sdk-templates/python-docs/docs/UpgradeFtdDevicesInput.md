...
**ignore_maintenance_window** | **bool** | A boolean value, indicating whether devices maintenance window should be ignored. If this is set to true, upgrade will be allowed even if there are devices outside their maintenance window. | [optional] [default to False]
