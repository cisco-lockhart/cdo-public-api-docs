...
json = "{}"
# create an instance of PolicyNodeDataPage from a JSON string
policy_node_data_page_instance = PolicyNodeDataPage.from_json(json)
# print the JSON string representation of the object
print(PolicyNodeDataPage.to_json())

# convert the object into a dict
policy_node_data_page_dict = policy_node_data_page_instance.to_dict()
# create an instance of PolicyNodeDataPage from a dict
policy_node_data_page_form_dict = policy_node_data_page.from_dict(policy_node_data_page_dict)
```
