...
json = "{}"
# create an instance of TaskDtoPage from a JSON string
task_dto_page_instance = TaskDtoPage.from_json(json)
# print the JSON string representation of the object
print(TaskDtoPage.to_json())

# convert the object into a dict
task_dto_page_dict = task_dto_page_instance.to_dict()
# create an instance of TaskDtoPage from a dict
task_dto_page_form_dict = task_dto_page.from_dict(task_dto_page_dict)
```
