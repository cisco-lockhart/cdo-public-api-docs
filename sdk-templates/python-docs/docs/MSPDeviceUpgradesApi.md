...
[**delete_msp_device_upgrade_run**](MSPDeviceUpgradesApi.md#delete_msp_device_upgrade_run) | **DELETE** /v1/msp/inventory/devices/ftds/upgrades/runs/{uid} | Delete MSP Device Upgrade Run
[**get_msp_device_upgrade_run**](MSPDeviceUpgradesApi.md#get_msp_device_upgrade_run) | **GET** /v1/msp/inventory/devices/ftds/upgrades/runs/{mspUpgradeRunUid} | Get MSP Device Upgrade Run
[**get_msp_device_upgrade_runs**](MSPDeviceUpgradesApi.md#get_msp_device_upgrade_runs) | **GET** /v1/msp/inventory/devices/ftds/upgrades/runs | Get MSP Device Upgrade Runs
...
[**get_msp_upgrade_runs_attribute_values**](MSPDeviceUpgradesApi.md#get_msp_upgrade_runs_attribute_values) | **GET** /v1/msp/inventory/devices/ftds/upgrades/runs/attribute-values | Get distinct attribute values for MSP upgrade runs
...
> MspUpgradeRunDto get_msp_device_upgrade_run(msp_upgrade_run_uid)
...
with scc_firewall_manager_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Get MSP Device Upgrade Run
        api_response = api_instance.get_msp_device_upgrade_run(msp_upgrade_run_uid)
...
# **get_msp_upgrade_runs_attribute_values**
> MspUpgradeRunsAttributeValues get_msp_upgrade_runs_attribute_values()
...
with scc_firewall_manager_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Get distinct attribute values for MSP upgrade runs
        api_response = api_instance.get_msp_upgrade_runs_attribute_values()
        print("The response of MSPDeviceUpgradesApi->get_msp_upgrade_runs_attribute_values:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MSPDeviceUpgradesApi->get_msp_upgrade_runs_attribute_values: %s\n" % e)
```
