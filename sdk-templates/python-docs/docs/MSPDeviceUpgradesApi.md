...
with scc_firewall_manager_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MSPDeviceUpgradesApi->upgrade_msp_managed_asa_secure_client_packages:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MSPDeviceUpgradesApi->upgrade_msp_managed_asa_secure_client_packages: %s\n" % e)
```
