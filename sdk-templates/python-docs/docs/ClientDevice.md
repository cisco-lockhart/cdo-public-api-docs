...
**encrypted** | **bool** | Indicates whether encryption is enabled on the client device. | [optional] [default to False]
**firewalled** | **bool** | Indicates whether a firewall is enabled on the client device. | [optional] [default to False]
**ip_address** | **str** | The IP address of the client device that has triggered this MFA event. | [optional] 
**location** | [**Location**](Location.md) |  | [optional] 
**os** | [**OS**](OS.md) |  | [optional] 
**password_set** | **bool** | Indicates whether a password is set on the client device. | [optional] [default to False]
