...
------------ | ------------- | ------------- | -------------
**display_name** | **str** | A human-readable display name for the enterprise (tenant). This is the tenant name displayed in the Security Cloud Control Web UI. | [optional] 
**name** | **str** | The name of the enterprise (tenant) in Security Cloud Control. | [optional] 
...
**uid** | **str** | The unique identifier, represented as a UUID, of the enterprise (tenant) in Security Cloud Control. | [optional] 
