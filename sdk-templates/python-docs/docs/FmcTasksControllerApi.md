# scc_firewall_manager_sdk.FmcTasksControllerApi
...
------------- | ------------- | -------------
[**get_tasks**](FmcTasksControllerApi.md#get_tasks) | **GET** /v1/ftd-services/tasks | 


# **get_tasks**
> PageTaskDto get_tasks(limit=limit, offset=offset, q=q, sort=sort)
...
with scc_firewall_manager_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = scc_firewall_manager_sdk.FmcTasksControllerApi(api_client)
    ...
    try:
        ...
        print("The response of FmcTasksControllerApi->get_tasks:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FmcTasksControllerApi->get_tasks: %s\n" % e)
```
