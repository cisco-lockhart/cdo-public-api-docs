...
**fmc_access_policy_uid** | **str** | Specify the unique identifier, represented as a UUID, of the FMC access policy to apply to this device. If this field is specified, the &#39;templates&#39; field must remain unspecified. Note: If both &#39;fmcAccessPolicyUid&#39; and &#39;template&#39; fields are unspecified, the operation will fail. | [optional] 
**licenses** | [**List[FtdLicenseType]**](FtdLicenseType.md) | Specify a set of licenses to apply to the device. | [optional] 
