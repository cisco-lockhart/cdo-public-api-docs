...
**meraki_physical_devices** | [**List[MerakiPhysicalDevice]**](MerakiPhysicalDevice.md) | (Meraki devices only) The physical devices associated with the Meraki appliance. | [optional] 
