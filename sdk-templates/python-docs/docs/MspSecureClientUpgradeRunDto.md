...
**managed_tenant_upgrades** | [**List[ManagedTenantUpgradeDto]**](ManagedTenantUpgradeDto.md) | Per-managed-tenant upgrade progress across this run. | [optional] 
...
**upgrade_run_status** | **str** | The current status of the upgrade run. One of: VALIDATING_INPUTS, UPLOADING_IMAGES, PERFORMING_UPGRADE, DONE, DONE_WITH_DEVICE_WARNINGS, DONE_WITH_DEVICE_ERRORS, ERROR. | [optional] 
