...
**ignore_maintenance_window** | **bool** | A boolean flag that determines whether device maintenance windows should be ignored during a full upgrade | [optional] [default to False]
