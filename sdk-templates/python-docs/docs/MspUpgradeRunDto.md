...
**force_upgrade** | **bool** | Indicates if this upgrade run is forced on the devices. If set to true, the upgrade is forcefully applied no matter the current upgrades staged on the devices | [optional] [default to False]
...
**stage_upgrade_only** | **bool** | Indicates if this upgrade run is to stage the upgrade on the device. If set to true, the upgrade is not applied on the device. | [optional] [default to False]
