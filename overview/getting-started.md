...
Security Cloud Control is deployed in multiple regions, and the API is available in all of these. The server URL for each region is as follows:

- US: https://edge.us.Security Cloud Control.cisco.com (use this if the Security Cloud Control URL you visit is https://www.defenseorchestrator.com)
- EU: https://edge.eu.Security Cloud Control.cisco.com (use this if the Security Cloud Control URL you visit is https://www.defenseorchestrator.eu)
- APJ: https://edge.apj.Security Cloud Control.cisco.com (use this if the Security Cloud Control URL you visit is https://apj.Security Cloud Control.cisco.com)
...
```curl
curl -X GET \                                                                                                             08:48:01
--url https://edge.us.Security Cloud Control.cisco.com/api/rest/v1/inventory/devices \
