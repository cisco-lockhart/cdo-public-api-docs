...
Prefer to use Postman rather than code or the command line? Check out our [Postman Collection](/docs/cisco-security-cloud-control-firewall-manager/postman-collections/).